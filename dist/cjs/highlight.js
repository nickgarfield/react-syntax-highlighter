...
function LineNumbers(_ref2) {
  ...
  return /*#__PURE__*/_react["default"].createElement("code", (0, _extends2["default"])({}, containerProps, {
...
function _default(defaultAstGenerator, defaultStyle) {
  return function SyntaxHighlighter(_ref6) {
    ...
    var lineNumbers = showLineNumbers ? /*#__PURE__*/_react["default"].createElement(LineNumbers, {
    ...
    if (!astGenerator) {
      return /*#__PURE__*/_react["default"].createElement(PreTag, preProps, lineNumbers, /*#__PURE__*/_react["default"].createElement(CodeTag, codeTagProps, code));
    }
    /*
    ...
    return /*#__PURE__*/_react["default"].createElement(PreTag, preProps, lineNumbers, /*#__PURE__*/_react["default"].createElement(CodeTag, codeTagProps, renderer({
      rows: tree,
      stylesheet: style,
      useInlineStyles: useInlineStyles
    })));
