...
var _default = {
  ...
  cs: (0, _createLanguageAsyncLoader["default"])("cs", function () {
    return Promise.resolve().then(function () {
      return (0, _interopRequireWildcard2["default"])(require("highlight.js/lib/languages/cs"));
    });
  }),
  ...
  nimrod: (0, _createLanguageAsyncLoader["default"])("nimrod", function () {
    return Promise.resolve().then(function () {
      return (0, _interopRequireWildcard2["default"])(require("highlight.js/lib/languages/nimrod"));
    });
  }),
  ...
  tex: (0, _createLanguageAsyncLoader["default"])("tex", function () {
    return Promise.resolve().then(function () {
      return (0, _interopRequireWildcard2["default"])(require("highlight.js/lib/languages/tex"));
    });
  }),
