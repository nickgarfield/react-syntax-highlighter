...
function LineNumbers(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("code", _extends({}, containerProps, {
...
export default function (defaultAstGenerator, defaultStyle) {
  return function SyntaxHighlighter(_ref6) {
    ...
    var lineNumbers = showLineNumbers ? /*#__PURE__*/React.createElement(LineNumbers, {
    ...
    if (!astGenerator) {
      return /*#__PURE__*/React.createElement(PreTag, preProps, lineNumbers, /*#__PURE__*/React.createElement(CodeTag, codeTagProps, code));
    }
    /*
    ...
    return /*#__PURE__*/React.createElement(PreTag, preProps, lineNumbers, /*#__PURE__*/React.createElement(CodeTag, codeTagProps, renderer({
      rows: tree,
      stylesheet: style,
      useInlineStyles: useInlineStyles
    })));
